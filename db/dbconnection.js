// local configuration
// db/dbconnection.js
// Uncomment the following lines to use the local configuration
...
// prod configuration
// Uncomment the following lines to use the production configuration
import { Sequelize } from "sequelize";
import dotenv from "dotenv";
dotenv.config();
...
export { User, License, Module, Banner, LicenseModule, UserInvoice, UserLicenseDetails };
